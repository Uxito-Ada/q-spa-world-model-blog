#!/usr/bin/env python3
"""Measure the complete Q-SPA FP8 Sol MiniMax-H3 profile on H100s."""
...
from qspa.core.config import AttnImplType  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--qspa-repo", type=Path, required=True)
    ...
    report = {
        ...
        "commit": git_commit(args.qspa_repo),
        ...
        "measurement": {
            ...
            "video_seconds_per_second": args.duration_seconds / median(e2e),
            "denoising_steps_per_second": 4.0 / median(denoise),

...
def main() -> None:
    ...
    parser.add_argument("--qspa", type=Path, required=True)
    ...
    qspa = load(args.qspa)
    reports = [baseline, qspa]
    names = ["FastVideo", "Q-SPA"]

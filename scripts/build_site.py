...
EDITIONS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": "Q-SPA co-designs quality-aware FP8, dynamic block sparsity, and distributed attention for world models.",
        "title": "Q-SPA: Quantized Sparse-Parallel Attention for World Models",
        "system_label": "System",
        ...
        "footer": "Q-SPA | Quantized Sparse-Parallel Attention",
    ...
    },
    {
        ...
        "description": "Q-SPA 面向世界模型协同设计 FP8、动态块稀疏与分布式 attention。",
        "title": "Q-SPA：面向世界模型的量化、稀疏与并行 attention",
        "system_label": "优化方案",
        "system_href": "#q-spa-system",
        "results_label": "测试结果",
        "results_href": "#results",
...
MEDIA = {
    ...
    "qspa-base-h3": "assets/qspa-base-h3.mp4",
    ...
    "turbo-qspa": "assets/turbo-qspa.mp4",
    "fastvideo-primary": "assets/fastvideo-primary.mp4",
    "qspa-primary": "assets/qspa-primary.mp4",
...
<body>
  <header class="topbar">
    <a class="brand" href="../README.md">Q-SPA</a>
    <nav aria-label="Article links">
      ...
      <a href="#q-spa-system">{edition["code_label"]}</a>

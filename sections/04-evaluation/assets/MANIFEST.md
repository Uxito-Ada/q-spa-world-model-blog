...
- `qspa-base-h3.mp4`: Q-SPA FP8 + Sol Base H3 output.
...
- `turbo-qspa.mp4`: Regenerated Q-SPA FP8 Turbo LoRA T2AV output using the same ramen prompt, seed, and four-GPU setup as the LightX2V and SGLang comparison renders; this clip uses the pre-smoothing FP8 Sol setting (smoothing=none).
- `fastvideo-primary.mp4`: FastVideo BF16 Linear + FA4 FastH3 dense-adapter output, four-GPU SP4 run.
- `qspa-primary.mp4`: Q-SPA FP8 Linear + FP8 Sol FastH3 dense-adapter output, four-GPU TP2 x Ulysses SP2 run.
